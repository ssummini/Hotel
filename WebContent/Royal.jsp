...
<body>
	...
	<div class="roomList" style="background-color: #EEEEEE; height: 370px;">
		<table class="table">
			...
			<tr>
				<td id="select" style="background-color: #C2C2C2;"><a href="Royal.jsp" style="color: white;">로열 <button id="next">&#10095;</button></a></td>
			</tr>
		</table>
	</div>
		...
		<div class="roomImg">
			<div id="Img">
				...
				<img src="img/royal2.jpg">
				<img src="img/royalbathroom.jpg">
		...
		<div class="roomInfo">
			<div id="roomContent">
				<h1 style="color:#6e583e;">로열 룸</h1><br />
				로열 룸은 여유로운 응접실과 다이닝 룸,<br />침실로 구성된 고급스러운 공간입니다.
			</div>
