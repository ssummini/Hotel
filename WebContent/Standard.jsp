...
<body>
	...
	<div class="roomList" style="background-color: #EEEEEE; height: 370px;">
		<table class="table">
			...
			<tr>
				<td id="select" style="background-color: #C2C2C2;"  ><a href="Standard.jsp" style="color: white;">스탠다드 <button id="next">&#10095;</button></a></td>
			</tr>
			<tr>
		...
		<div class="roomImg">
			<div id="Img">
				...
				<img src="img/standard2.jpg">
				<img src="img/standardbathroom.jpg">
